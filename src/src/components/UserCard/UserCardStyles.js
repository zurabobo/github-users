...
//   /* box-shadow: 2px 4px 17px 0 #55aeff; */
//   box-shadow: inset 1px 1px 10px 0 #55aeff;
//   &::before {
//     content: "";
...
//   color: ${(props) => (!props.number ? "#7d7d7d" : "#191919")};;
// `;
...
const hoverEffect = css`
  ...
  box-shadow: 0px 2px 3px 1px #c6d9ed8a;
...
export const Article = styled.article`
  ...
  /* background-color: #2a2a2a; */
  padding: 10px 15px 15px 15px;
  border: 1px solid #c6d9ed8a;
  /* color: red; */
  height: 74px;
  box-shadow: 0px 4px 6px 2px #c6d9ed8a;
...
export const Avatar = styled.img`
  ...
  border: 1px solid #c6d9ed8a;
  /* box-shadow: 0px 0px 6px 0px #191919; */
  box-shadow: 0px 3px 6px 1px #c6d9ed8a;
  ${Article}:hover & {
    ${hoverEffect}
  }
